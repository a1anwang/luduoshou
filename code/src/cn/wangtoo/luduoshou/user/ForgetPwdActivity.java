...
public class ForgetPwdActivity extends LuBaseActivity {
	...
	private void queryAuthCode(final String phoneNum) {
		...
		RequestBody formBody = new FormBody.Builder()
				.add("targetPhoneNum", phoneNum).add("type", "2").build();
			...
			public void onFailure(Call arg0, IOException arg1) {
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						ToastUtils.showToast(ForgetPwdActivity.this, "获取失败，请重试 ", 2000);
						myProgressDialog.dismiss();
					}
				});
